export const REAL = [
  ['Indicator inventory','All 326 metrics, their categories, responsible entities, availability, frequency and gap classification, loaded unmodified from 20250908_Data indicators.xlsx.'],
...
export const MODELLED = [
  ['Quarterly values','Shaped to the published annual anchors to 2025, then distributed across quarters. Indicative, not published figures.'],
  ['The running quarter','A modelled 2026 Q1 so the provisional state, the estimate and the exception queue can be exercised.'],
  ['The nowcast path','Populated synthetic figures for a publicly hosted prototype. Not a MISA calculation. Demonstrates the mechanism, not model accuracy.'],
  ['Back-test record','Populated synthetic estimate-versus-actual rows. Not MISA calculations. Shows that accuracy is itself tracked.'],
  ['Source records','Transaction identifiers at the deepest drill level are illustrative.']
];
